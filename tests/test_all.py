...
@pytest.mark.filterwarnings("ignore:The WCS transformation has more axes (2) than the image it is associated with (0)")
def test_fits2azel():
    ...
    assert scale['az'].values[[32, 51, 98], [28, 92, 156]] == approx([22.794418, 20.788267, 17.572719])
    assert scale['el'].values[[32, 51, 98], [28, 92, 156]] == approx([17.359846, 15.084063, 13.287209])
